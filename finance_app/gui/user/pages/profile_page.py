...
class UserProfilePage(BaseWidget):
    ...
    def init_ui(self):
        ...
        self.current_password = self.create_input_field("Nhập mật khẩu hiện tại", is_password=True)
        ...
        self.new_password = self.create_input_field("Nhập mật khẩu mới", is_password=True)
        ...
        self.confirm_password = self.create_input_field("Nhập lại mật khẩu mới", is_password=True)
    ...
    def update_user_info(self, user_data):
        ...
        self.stats_panel.update_data(user_data.get('user_id'))
